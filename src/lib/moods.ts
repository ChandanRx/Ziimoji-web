...
export const moods: Mood[] = [
  ...
  { label: "Excited", emoji: "\u{1F929}", lottie: "/emoji/excited.lottie", accent: "#3f8a1a", chip: "#e4f7c7", tint: "#f6fcec", border: "#c3e88f", grad: "linear-gradient(90deg,#9ee84d,#4caf50)", Icon: Sparkles },
