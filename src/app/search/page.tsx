    ...
    <div className="flex h-screen">
      <div className="flex-1 overflow-y-auto pt-14 pb-16 md:pt-0 md:pb-0 md:ml-[264px] lg:pr-80">
        <div className="max-w-2xl mx-auto px-6 py-8">
          ...
          {/* Search bar */}
          <div className="sticky top-2 z-20 mb-8 flex items-center gap-3 bg-white rounded-[16px] px-4 py-3 border border-[var(--line)] shadow-[var(--shadow-sm)] focus-within:shadow-[var(--shadow-md)] transition-shadow">
