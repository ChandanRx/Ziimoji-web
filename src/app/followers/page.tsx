...
function PersonRow({ person }: { person: Person }) {
  ...
  return (
    <div className="flex items-center gap-3 px-3 py-3 rounded-sm hover:bg-[var(--canvas)] transition-colors">
      ...
      <Link href={`/profile/${person.id}`} className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5">
          ...
          >
            <AnimatedEmoji src={mood.lottie} size={12} label={mood.label} />
            {mood.label}
          </span>
        </div>
