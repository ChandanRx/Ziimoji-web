    ...
    <aside className="hidden lg:block w-80 h-screen fixed right-0 top-0 overflow-y-auto no-scrollbar border-l border-[var(--line)] bg-white">
      <div className="p-5 space-y-4">
        ...
        <Link
          ...
          className="flex items-center gap-3 p-3 rounded-[18px] border border-[var(--line)] hover:bg-[var(--canvas)] transition-colors group"
        >
        ...
        <section className="p-4 rounded-[18px] border border-[var(--line)]">
